...
# Based on: https://github.com/jeyong-shin/adk-codingtest-gen-agent/blob/main/codingtest-generator/sub_agents/problem_solver/agent.py (retrieved 2025-05-19)
...
from ...shared_lib.constants import STATE_PROBLEM_SOLVER
...
problem_solver_agent = LlmAgent(
  ...
  output_key=STATE_PROBLEM_SOLVER
)